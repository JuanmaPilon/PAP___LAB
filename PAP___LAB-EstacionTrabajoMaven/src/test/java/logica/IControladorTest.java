...
//        
//
//        DTTurista dtTurista = control.traerDTTurista(nickname1);
...
//        
//        DTProveedor dtProveedor = control.traerDTProveedor( nickname1);
...
//        ArrayList<String> listaCatAct = control.listaActividadesTuristicasPorCategoria("catAct");
//        
//        ArrayList<String> listaActEstado = control.listaActividadesPorEstado(TipoEstado.agregada);
...
//        
//       ArrayList<String> listProv = control.listaActividadesProveedorTodas("pAct") ;
...
//            Date fAltahoy = fechahoy.parse("24/10/2023");
// 
...
//            
//            control.crearPaqueteActividadTuristica("Paq", "PaqDesc", 10, fAltahoy, 20);
//            control.asignarActividadPaquete( "Paq", "ActSalPaq");
//            
//            Throwable exception1 = assertThrows(PreexistingEntityException.class, () -> {
//                control.crearPaqueteActividadTuristica("Paq", "PaqDesc", 10, fAlta1, 20);
//        });
//            ArrayList<String> listActPaq = control.listaActividadesDelPaquete("Paq");
...
//            ArrayList<String> listpaqcompra = control.listaPaquetesSinCompra();
//          //  ArrayList<Paquete> listPaqV = control.listaPaquetesVigentesSalida("ActSalPaq");
//            
//            
//    }
//        
...
//            System.out.println("TestAltaInscripcionnnnnnn");
//            
//            SimpleDateFormat fecha = new SimpleDateFormat("dd/MM/yyyy");
//            Date fAlta1 = fecha.parse("23/2/1927");
// 
//            control.AltaDeDepartamento("dActIns", "deptoDesc", "deptoURL");
//            control.AltaCategoria("catActIns");
//            ArrayList<String> listcat1 = new ArrayList();
//            listcat1.add("catActIns");
//            control.AltaDeUsuarioProveedor("pActSalIns", "pnom", "Pape", "contra", "PActSalPaqcorreoIns",fAlta1, "PActdesc", "PActlink" );
//            control.AltaDeUsuarioTurista("TurIns", "TurIns", "TurIns", "TurIns", "TurIns", fAlta1, "griega");
//            control.guardarActividad("ActSalIns", "ActSalPaqDesc", 1, 1, 
//                    "ActSalPaqCiu", fAlta1, "pActSalIns", "dActIns", listcat1);
//            control.AltaSalidaTuristica("SalPaqIns", 2, fAlta1, fAlta1, "ActSalPaqCiu","ActSalIns" );
//            
//            control.crearPaqueteActividadTuristica("PaqIns", "PaqDesc", 10, fAlta1, 20);
//            control.asignarActividadPaquete( "PaqIns", "ActSalIns");
//            
//            control.InscripcionASalidaTuristica("SalPaqIns",  "TurIns", 20, 20, fAlta1, TipoPago.general );
//            
//
//            boolean inscTur =  control.turistaYaInscriptoSalidaTuristica("SalPaqIns", "TurIns");
//            
//            assertTrue(inscTur);
//            
//            ArrayList<DTSalidaTuristica> listInsSal = control.traerInscSalidasDeTurista("TurIns");
//            assertEquals("SalPaqIns", listInsSal.get(0).getNombre());
//            
//            ArrayList<DTActividad> listInsAct = control.traerInscActividadesDeTurista("TurIns");
//            assertEquals("ActSalIns", listInsAct.get(0).getNombre());
//            
//            boolean cantInsSal = control.salidaTuristicaLlena("SalPaqIns", 3);
//            
//            assertTrue(cantInsSal);
//    }
//        
//                @Test
//        public void testCompra() throws Exception {
//            System.out.println("TestAltaCompra");
//            
//            SimpleDateFormat fecha = new SimpleDateFormat("dd/MM/yyyy");
//            Date fAlta1 = fecha.parse("23/2/1927");
// 
//            control.AltaDeDepartamento("dActInsC", "deptoDesc", "deptoURL");
//            control.AltaCategoria("catActInsC");
//            ArrayList<String> listcat1 = new ArrayList();
//            listcat1.add("catActInsC");
//            control.AltaDeUsuarioProveedor("pActSalInsC", "pnom", "Pape", "contra", "PActSalPaqcorreoInsC",fAlta1, "PActdesc", "PActlink" );
//            control.AltaDeUsuarioTurista("TurInsC", "TurIns", "TurIns", "TurIns", "TurInsC", fAlta1, "griega");
//            control.AltaDeUsuarioTurista("TurInsCCC", "TurIns", "TurIns", "TurIns", "TurInsCCC", fAlta1, "griega");
//            control.guardarActividad("ActSalInsC", "ActSalPaqDesc", 1, 1, 
//                    "ActSalPaqCiu", fAlta1, "pActSalInsC", "dActInsC", listcat1);
//            control.AltaSalidaTuristica("SalPaqInsC", 2, fAlta1, fAlta1, "ActSalPaqCiu","ActSalInsC" );
//            
//            control.crearPaqueteActividadTuristica("PaqInsC", "PaqDesc", 10, fAlta1, 20);
//            control.crearPaqueteActividadTuristica("PaqInsCCC", "PaqDesc", 10, fAlta1, 20);
//            control.asignarActividadPaquete( "PaqInsC", "ActSalInsC");
//            
//            control.CompraDePaquete("TurInsC",  "PaqInsC", 5, fAlta1);
//          
//            Throwable exception1 = assertThrows(PaqueteYaComprado.class, () -> {
//                control.CompraDePaquete("TurInsC",  "PaqInsC", 5, fAlta1);
//        });      
//            Compra c = control.traerCompraDelTurista("TurInsC", "PaqInsC");   
//            
//            ArrayList<String> listPaqComp = control.listaPaquetesComprados("TurInsC");
//            
//
//    }
//        
