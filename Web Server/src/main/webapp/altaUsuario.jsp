...
// Esta funci�n se ejecutar� cuando se cargue la p�gina
            window.onload = function () {
                // Llamamos a mostrarCampos() para asegurarnos de que el formulario tenga la acci�n correcta al cargar la p�gina
                mostrarCampos();
            };
        </script>
        ...
        <form id="formularioRegistro" action=SvTurista method="post" accept-charset="UTF-8">
            ...
            <div id="camposProveedor" style="display:none;">
                ...
                <textarea placeholder="Escribe aqu� tu descripci�n..." id="descripcion" name="descripcion" rows="4"></textarea>
